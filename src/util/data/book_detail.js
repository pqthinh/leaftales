  ...
  content: [
    {
      ...
      sentences: [
        ...
        Chính vì vậy, trong thời đại ngày nay, con người Việt Nam càng cần biết giữ gìn và phát huy sự trong sáng, giàu đẹp của tiếng Việt. Qua việc trân trọng và bảo vệ ngôn ngữ quốc gia, chúng ta đồng thời bảo toàn và truyền đạt những giá trị văn hóa, truyền thống quý báu của dân tộc.`).split(`.`).map(e=> e+'.')]
      ],
    },
    {
